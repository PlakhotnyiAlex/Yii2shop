...
class FlySystemImageUploadBehavior extends ImageUploadBehavior
{
    ...
    public function afterSave(): void
    {
        if ($this->file instanceof UploadedFile) {
            ...
            $this->filesystem->write($path, file_get_contents($this->file->tempName));
    ...
    public function createThumbs(): void
    {
        ...
        foreach ($this->thumbs as $profile => $config) {
            ...
            if ($this->filesystem->has($path) && !$this->filesystem->has($thumbPath)) {
                ...
                file_put_contents($tmpPath, $this->filesystem->read($path));
                ...
                $this->filesystem->write($thumbPath, file_get_contents($tmpPath));
            }
        }
    }
